...
object Libs {
  val `esw-http-template-wiring` = "com.github.tmtsoftware.esw" %% "esw-http-template-wiring" % "0.3.0-RC2"
  // #add-db
  val `csw-database` = "com.github.tmtsoftware.csw" %% "csw-database" % "4.0.0-RC2"
  // #add-db
